...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        <title>Bengkel Las Mandiri - XML Sitemap Index</title>
      ...
      <body>
        <div class="container">
          <header>
            <h1><span class="brand">MANDIRI STEEL</span> XML Sitemap Index</h1>
            <p class="subtitle">Bengkel Las Mandiri (Mandiri Steel) - Bekasi, Indonesia</p>
          </header>
          ...
          <footer>
            <p>Generated by Mandiri Steel Sitemap Generator</p>
            <p style="margin-top: 10px;">
              <a href="https://lasbekasi.com" target="_blank">← Back to Bengkel Las Mandiri</a>
            </p>
          </footer>
        </div>
      </body>
