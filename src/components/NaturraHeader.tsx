        ...
        <div className="naturra-header__topbar">
          <div className="naturra-header__topbar-inner">
            <div className="naturra-header__topbar-left">
              <a href="mailto:info@lasbekasi.com">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
                info@lasbekasi.com
              </a>
              <a href="https://wa.me/6285212078467" target="_blank" rel="noopener noreferrer">
        ...
        <div className="naturra-header__main">
          <Link to="/" className="naturra-header__logo">
            ...
            <div className="naturra-header__logo-text">
              <span className="naturra-header__logo-name">BENGKEL LAS MANDIRI</span>
              <span className="naturra-header__logo-tagline">Mandiri Steel</span>
            </div>
          </Link>
              ...
              <div className="naturra-search-inner">
                <div className="naturra-search-input-wrapper">
                  ...
                  <input
                    ...
                    placeholder="Cari layanan (kanopi, pagar, tralis)..."
                    value={searchQuery}
                ...
                {!searchQuery && (
                  <div className="naturra-search-suggestions">
                    <span>Populer:</span>
                    <Link to="/products" onClick={closeSearch}>Kanopi</Link>
                    <Link to="/products" onClick={closeSearch}>Pagar Besi</Link>
                    <Link to="/products" onClick={closeSearch}>Teralis</Link>
                  </div>
                )}
              </div>
            </div>
