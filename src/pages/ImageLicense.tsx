...
const heroImage = 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=1920&auto=format&fit=crop&q=80'
...
const IMAGE_LICENSE_TRANSLATIONS: Record<LanguageCode, ImageLicenseTranslation> = {
  en: {
    meta: {
      title: 'Image Usage & Licensing - Mandiri Steel',
      description:
        'Mandiri Steel image licensing policy, copyright details, and how to obtain permission for commercial usage of our welding and steel fabrication project imagery.'
    },
    hero: {
      title: 'Image Usage & Licensing',
      subtitle:
        'Official guidance on copyright, licensing policies, and how to request permission to use Mandiri Steel imagery.',
      imageAlt: 'Mandiri Steel Image Usage & Licensing',
      imageTitle: 'Mandiri Steel Image License Policy',
      caption: 'Mandiri Steel Image Licensing & Usage - Bekasi Steel Fabrication Workshop'
    },
    sections: {
      usageHeading: 'Image Usage Terms',
      usageIntro:
        "We are committed to protecting Mandiri Steel's brand identity. Please review the following requirements before using our visual assets:",
      usageItems: [
        'All photos and visuals of our projects (canopies, gates, stairs, etc.) are the property of Mandiri Steel and protected by copyright law.',
        'Using our images without written permission is prohibited, including for commercial, marketplace, and promotional purposes.',
        'Watermarks and credits must remain intact. Attribution usage must include "Mandiri Steel" and a link to the official website.',
      ...
      permittedItems: [
        ...
        'Digital or printed marketing assets that promote an official collaboration with Mandiri Steel.'
      ],
      copyrightHeading: 'Copyright & Attribution',
      copyrightParagraph:
        'Each image contains digital watermarking and metadata trails to safeguard copyright. Attribution usage must include "Mandiri Steel" and a link to https://lasbekasi.com.',
    ...
    cta: {
      ...
      button: 'Contact Mandiri Steel'
    }
  },
  id: {
    meta: {
      title: 'Lisensi & Penggunaan Gambar - Mandiri Steel',
      description:
        'Kebijakan lisensi gambar Mandiri Steel, hak cipta, dan cara memperoleh izin penggunaan gambar portofolio proyek pengelasan & fabrikasi kami.'
    },
    hero: {
      title: 'Lisensi & Penggunaan Gambar',
      subtitle:
        'Panduan resmi mengenai hak cipta, kebijakan lisensi, dan cara mengajukan izin penggunaan gambar proyek Mandiri Steel.',
      imageAlt: 'Lisensi & Penggunaan Gambar Mandiri Steel',
      imageTitle: 'Kebijakan Lisensi Gambar Mandiri Steel',
      caption: 'Lisensi & Penggunaan Gambar Mandiri Steel - Workshop Pengelasan & Fabrikasi Bekasi'
    },
    sections: {
      usageHeading: 'Ketentuan Penggunaan Gambar',
      usageIntro:
        'Kami berkomitmen menjaga kualitas citra brand Mandiri Steel. Mohon ikuti ketentuan berikut sebelum menggunakan aset visual kami:',
      usageItems: [
        'Semua foto dan visual hasil pengerjaan proyek kami (kanopi, pagar, railing, teralis, dsb) adalah properti Mandiri Steel dan dilindungi oleh undang-undang hak cipta.',
        'Penggunaan gambar tanpa izin tertulis tidak diperbolehkan, termasuk untuk keperluan komersial, marketplace, dan promosi kompetitor.',
        'Kredensial dan watermark tidak boleh dihapus. Penggunaan dengan atribusi harus mencantumkan "Mandiri Steel" dan tautan ke situs resmi.',
      ...
      permittedItems: [
        ...
        'Materi pemasaran digital atau cetak yang mempromosikan kerjasama resmi dengan Mandiri Steel.'
      ],
      copyrightHeading: 'Hak Cipta & Atribusi',
      copyrightParagraph:
        'Setiap gambar memiliki watermark digital dan catatan metadata untuk memastikan perlindungan hak cipta. Penggunaan dengan atribusi harus mencantumkan "Mandiri Steel" dan tautan ke https://lasbekasi.com.',
    ...
    cta: {
      ...
      button: 'Hubungi Tim Mandiri Steel'
    }
  },
  ar: {
    meta: {
      title: 'ترخيص واستخدام الصور - مانديري ستيل',
      description: 'سياسة ترخيص الصور لدى مانديري ستيل، تفاصيل حقوق النشر، وكيفية الحصول على إذن للاستخدام التجاري.'
    },
    hero: {
      title: 'ترخيص واستخدام الصور',
      subtitle:
        'إرشادات رسمية حول حقوق النشر وسياسات الترخيص وكيفية طلب إذن لاستخدام صور مانديري ستيل.',
      imageAlt: 'ترخيص واستخدام صور مانديري ستيل',
      imageTitle: 'سياسة ترخيص الصور لدى مانديري ستيل',
      caption: 'ترخيص واستخدام صور مانديري ستيل - ورشة لحام وتصنيع الفولاذ في بيكاسي'
    },
    sections: {
      usageHeading: 'شروط استخدام الصور',
      usageIntro:
        'نلتزم بحماية هوية علامة مانديري ستيل. الرجاء الاطلاع على المتطلبات التالية قبل استخدام أصولنا المرئية:',
      usageItems: [
        'جميع الصور والمواد المرئية لمشاريعنا ملك لـ مانديري ستيل ومحمية بقوانين حقوق النشر.',
        'يحظر استخدام الصور بدون إذن خطي، بما في ذلك الأغراض التجارية، والأسواق الإلكترونية، والحملات الترويجية.',
        'يجب الحفاظ على العلامة المائية والاعتمادات. في حالة الإسناد، يجب ذكر "مانديري ستيل" مع رابط إلى الموقع الرسمي.',
      ...
      permittedItems: [
        ...
        'مواد التسويق الرقمية أو المطبوعة التي تروّج لتعاون رسمي مع مانديري ستيل.'
      ],
      copyrightHeading: 'حقوق النشر والإسناد',
      copyrightParagraph:
        'تحتوي كل صورة على علامة مائية رقمية وبيانات وصفية لحماية حقوق النشر. يجب أن يتضمن الاستخدام مع الإسناد اسم "مانديري ستيل" ورابطًا إلى https://lasbekasi.com.',
    ...
    cta: {
      ...
      button: 'تواصل مع مانديري ستيل'
    }
  },
  zh: {
    meta: {
      title: '图片使用与授权政策 - Mandiri Steel',
      description: 'Mandiri Steel 图片授权政策、版权说明，以及如何获取焊接和钢结构项目图像的商业使用许可。'
    },
    hero: {
      title: '图片使用与授权',
      subtitle: '关于版权、授权政策以及如何申请使用 Mandiri Steel 图像的官方指南。',
      imageAlt: 'Mandiri Steel 图片使用与授权',
      imageTitle: 'Mandiri Steel 图片授权政策',
      caption: 'Mandiri Steel 图片授权与使用 - 勿加泗钢结构制造工坊'
    },
    sections: {
      usageHeading: '图片使用条款',
      usageIntro: '我们致力于维护 Mandiri Steel 的品牌形象。使用我们的视觉素材前，请遵循以下要求：',
      usageItems: [
        '我们项目的所有照片和视觉素材（雨棚、大门、楼梯等）均为 Mandiri Steel 的财产，并受版权法保护。',
        '未经书面许可，不得使用我们的图片，包括商业、商城或推广用途。',
        '不得移除水印或署名。使用时须注明 “Mandiri Steel” 并附上官方网站链接。',
      ...
      permittedItems: [
        ...
        '用于宣传与 Mandiri Steel 官方合作的数字或印刷营销材料。'
      ],
      copyrightHeading: '版权与署名',
      copyrightParagraph:
        '每张图片都包含数字水印和元数据以保护版权。署名使用时必须注明 “Mandiri Steel” 并附上 https://lasbekasi.com 链接。',
    ...
    cta: {
      ...
      button: '联系 Mandiri Steel'
    }
  },
  ja: {
    meta: {
      title: '画像使用およびライセンスについて - Mandiri Steel',
      description: 'Mandiri Steel の画像ライセンス方針、著作権の詳細、および溶接・鋼構造物プロジェクトの画像使用許可取得方法。'
    },
    hero: {
      title: '画像使用とライセンス',
      subtitle: '著作権、ライセンス方針、Mandiri Steel の画像使用許可の申請方法に関する公式ガイド。',
      imageAlt: 'Mandiri Steel 画像使用とライセンス',
      imageTitle: 'Mandiri Steel 画像ライセンス規約',
      caption: 'Mandiri Steel 画像ライセンスと使用 - ベカシ鋼構造物ワークショップ'
    },
    sections: {
      usageHeading: '画像使用に関する規定',
      usageIntro: 'Mandiri Steel のブランド価値を守るため、以下の条件を必ずご確認ください。',
      usageItems: [
        'すべての写真・ビジュアル（キャノピー、ゲート、階段など）は Mandiri Steel の所有物であり、著作権法によって保護されています。',
        '書面による許可なく画像を使用することは禁止されています（商用利用、マーケットプレイス、プロモーション等を含む）。',
        'ウォーターマークやクレジット表記を削除しないでください。クレジット表記を行う場合は「Mandiri Steel」と公式サイトへのリンクを必ず記載してください。',
      ...
      permittedItems: [
        ...
        'Mandiri Steel と公式に協業していることを示すデジタルまたは印刷のマーケティング素材。'
      ],
      copyrightHeading: '著作権とクレジット',
      copyrightParagraph: '各画像には著作権保護のためのデジタル透かしとメタデータが含まれています。クレジット表記を行う場合は「Mandiri Steel」と https://lasbekasi.com へのリンクを必ず記載してください。',
    ...
    cta: {
      ...
      description: '商用または編集用途に合わせたライセンスパッケージについては、お気軽に Mandiri Steel までお問い合わせください。',
      button: 'Mandiri Steel に問い合わせる'
    }
  },
  es: {
    meta: {
      title: 'Uso y Licencia de Imágenes - Mandiri Steel',
      description: 'Política de licencias de imágenes de Mandiri Steel, detalles de copyright y cómo obtener permiso para uso comercial de nuestras imágenes de proyectos de soldadura y herrería.'
    },
    hero: {
      title: 'Uso y Licencia de Imágenes',
      subtitle: 'Guía oficial sobre derechos de autor, políticas de licencia y cómo solicitar permiso para utilizar las imágenes de Mandiri Steel.',
      imageAlt: 'Uso y licencia de imágenes de Mandiri Steel',
      imageTitle: 'Política de licencia de imágenes de Mandiri Steel',
      caption: 'Uso y licencia de imágenes de Mandiri Steel - Taller de herrería en Bekasi'
    },
    sections: {
      usageHeading: 'Términos de uso de las imágenes',
      usageIntro: 'Nos comprometemos a proteger la identidad de la marca Mandiri Steel. Revisa los siguientes requisitos antes de utilizar nuestros recursos visuales:',
      usageItems: [
        'Todas las fotos y recursos visuales de nuestros proyectos (doseles, portones, escaleras, etc.) son propiedad de Mandiri Steel y están protegidos por leyes de derechos de autor.',
        ...
        'No se debe eliminar el crédito ni la marca de agua. En caso de atribución, debe mencionarse “Mandiri Steel” con un enlace al sitio oficial.',
      ...
      permittedItems: [
        ...
        'Materiales de marketing digitales o impresos que promocionen una colaboración oficial con Mandiri Steel.'
      ],
      copyrightHeading: 'Derechos de autor y atribución',
      copyrightParagraph: 'Cada imagen contiene marcas de agua digitales y metadatos para proteger los derechos de autor. La atribución debe incluir “Mandiri Steel” y un enlace a https://lasbekasi.com.',
    ...
    cta: {
      ...
      description: 'Contacta a nuestro equipo para recibir un paquete de licencia comercial o editorial adaptado a tu proyecto.',
      button: 'Contactar a Mandiri Steel'
    }
  },
  fr: {
    meta: {
      title: 'Utilisation et Licence des Images - Mandiri Steel',
      description: 'Politique de licence des images Mandiri Steel, détails sur le droit d’auteur et procédures pour obtenir une autorisation d’usage commercial de nos visuels de métallurgie.'
    },
    hero: {
      title: 'Utilisation & Licence des Images',
      subtitle: 'Guide officiel sur le droit d’auteur, les politiques de licence et la manière de demander l’autorisation d’utiliser les visuels Mandiri Steel.',
      imageAlt: 'Utilisation et licence des images Mandiri Steel',
      imageTitle: 'Politique de licence des images Mandiri Steel',
      caption: 'Utilisation et licence des images Mandiri Steel - Atelier de fabrication d\'acier de Bekasi'
    },
    sections: {
      usageHeading: 'Conditions d’utilisation des images',
      usageIntro: 'Nous nous engageons à protéger l’identité de marque de Mandiri Steel. Merci de respecter les règles suivantes avant d’utiliser nos contenus visuels :',
      usageItems: [
        'Toutes les photos et visuels de nos réalisations (auvents, portails, escaliers, etc.) sont la propriété de Mandiri Steel et protégés par le droit d’auteur.',
        ...
        'Les crédits et filigranes ne doivent pas être supprimés. En cas d’attribution, mentionnez “Mandiri Steel” avec un lien vers le site officiel.',
      ...
      permittedItems: [
        ...
        'Supports marketing imprimés ou digitaux promouvant une collaboration officielle avec Mandiri Steel.'
      ],
      copyrightHeading: 'Droit d’auteur & attribution',
      copyrightParagraph: 'Chaque image comporte un filigrane numérique et des métadonnées pour assurer la protection du droit d’auteur. Toute attribution doit mentionner “Mandiri Steel” et inclure le lien https://lasbekasi.com.',
    ...
    cta: {
      ...
      description: 'Contactez notre équipe pour obtenir un pack de licence commerciale ou éditoriale adapté à votre projet.',
      button: 'Contacter Mandiri Steel'
    }
  },
  ko: {
    meta: {
      title: '이미지 사용 및 라이선스 정책 - Mandiri Steel',
      description: 'Mandiri Steel 이미지 라이선스 정책, 저작권 안내, 그리고 용접 및 철강 프로젝트 이미지의 상업적 사용 허가를 받는 방법.'
    },
    hero: {
      title: '이미지 사용 및 라이선스',
      subtitle: 'Mandiri Steel 이미지의 저작권과 라이선스 정책, 사용 허가 신청 방법에 대한 공식 가이드입니다.',
      imageAlt: 'Mandiri Steel 이미지 사용 및 라이선스',
      imageTitle: 'Mandiri Steel 이미지 라이선스 정책',
      caption: 'Mandiri Steel 이미지 사용 및 라이선스 - 베카시 철골 구조물 공방'
    },
    sections: {
      usageHeading: '이미지 사용 조건',
      usageIntro: 'Mandiri Steel 브랜드 아이덴티티 보호를 위해 다음 사항을 반드시 준수해 주세요.',
      usageItems: [
        '저희 프로젝트(캐노피, 대문, 계단 등)의 모든 사진과 비주얼 자료는 Mandiri Steel의 자산이며 저작권법의 보호를 받습니다.',
        '서면 허가 없이 이미지를 사용하는 것은 금지됩니다. (상업적, 마켓플레이스, 프로모션 목적 포함)',
        '워터마크와 출처 표기를 삭제할 수 없습니다. 출처 표기를 할 경우 “Mandiri Steel”과 공식 웹사이트 링크를 반드시 기재해야 합니다.',
      ...
      permittedItems: [
        ...
        'Mandiri Steel과의 공식 협업을 홍보하는 디지털 또는 인쇄 마케팅 자료.'
      ],
      copyrightHeading: '저작권 및 출처 표기',
      copyrightParagraph: '각 이미지는 저작권 보호를 위한 디지털 워터마크와 메타데이터를 포함하고 있습니다. 출처 표기 시 “Mandiri Steel”과 https://lasbekasi.com 링크를 반드시 포함해 주세요.',
    ...
    cta: {
      ...
      description: '다가오는 프로젝트에 맞는 맞춤형 상업/편집 용 라이선스 패키지를 받으려면 팀에 문의해 주세요.',
      button: 'Mandiri Steel 문의하기'
    }
  }
}

const HERO_IMAGE_URL = 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=1200&auto=format&fit=crop'
